...
// echo '이름'.$name;
// echo '<br>차수'.$nth;
// echo '<br>강사코드'.$teacher_code;
// echo '<br>강사명'.$teacher_name;
// echo '<br>카1'.$category1;
// echo '<br>카2'.$category2;
// echo '<br>카3'.$category3;
// echo '<br>장소'.$place;
// echo '<br>폰'.$phone;
// echo '<br>난이도'.$grade;
// echo '<br>시작시간'.$start_time;
// echo '<br>종료시간'.$end_time;
// echo '<br>시작일'.$start_date;
// echo '<br>종료일'.$end_date;
// echo '<br>인원'.$member_num;
// echo '<br>작성일'.$datetime;
// echo '<br>썸네일'.$img;
// echo '<br>사진'.$parent_img;
// echo '<br>디테일'.$detail;
