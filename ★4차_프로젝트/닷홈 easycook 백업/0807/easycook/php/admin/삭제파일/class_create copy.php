...
<main>
  <section class="m-center m-auto mb-5 class_size">
    <!-- 부스러기 -->
    <p class="bread"><a href="index.php">홈</a> &#x003E; 강의 관리 &#x003E; <span style="font-weight:bold">강의 개설</span></p>
      ...
      <article class="class_create">
        ...
        <div class="create_l">
          ...
          <table class="table create_table">
            ...
            <tr>
              <td>정원</td>
              <td><input type="number" name="member_num" id="member_num" class="form-control" required></td>
              <td>종료시간</td>
        ...
        <div>
          ...
          <div class="mb-4">
            <textarea name="detail" id="detail" cols="30" rows="10" placeholder="추가 설명" class="form-control mb-1"></textarea>
        ...
        <a href="class_1.php" title="강의목록으로" class="admin_btn admin_btn_yellow">강의목록</a>
        <input type="reset" value="초기화" class="admin_btn admin_btn_gray">
        <input type="submit" value="강의등록" class="admin_btn admin_btn_red">
      </article>
    </form>
  </section>
  <?php
