...
<head>
  ...
  <!-- 부스러기 -->
    ...
    <form action="answer_input.php" name="답변하기" method="post">
      <table class="table m-auto mt-5" style="width: 90%; max-width: 1000px; font-size: 14px;">
      ...
      <thead>
        <tr>
          <th colspan="2">
            ...
            <span style="float: right; font-weight:var(--fw-light);"><?php echo $q[2];?> &nbsp;&nbsp;
            <span style="float: right; font-weight:var(--fw-light);"><?php echo date("Y.m.d",strtotime($q[5]));?></span>
          </th>
        </tr>
        <tr>
          <th colspan="2"><?php echo $q[3];?></th>
        </tr>
      </thead>
      <tbody style="height: 359px;">
        <tr>
          <td colspan="2"><?php echo $q[4];?></td>
        </tr>
