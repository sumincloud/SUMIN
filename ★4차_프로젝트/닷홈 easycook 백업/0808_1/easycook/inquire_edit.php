      ...
      <article>
        <?php if($edit=='수정'){ ?>
          ...
          <form action="./php/inquire_update.php" method="post">
            ...
            <input type="text" value="<?php echo $row2['question'] ?>"  placeholder="<?php echo $row2['question'] ?>" name="question" required>
            <textarea  name="question_memo" maxlength="255" required ><?php echo htmlspecialchars($row2['question_memo']) ?></textarea>
