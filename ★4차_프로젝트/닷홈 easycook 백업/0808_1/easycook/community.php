        ...
        <?php }else if($tab == '상담신청') { ?>
          ...
          <article id="page2" class="inquire">
            ...
            <form name="" method="post" action="./php/off_inq_send.php">
              ...
              <input type="text" value="" name="inquire_name" id="inquire_name" required>
              <!-- <br> -->
              <label for="inquire_phone" >전화번호</label>
              <input type="text" value="" name="inquire_phone" id="inquire_phone" required>

              <label for="inquire_memo" >상담 내용</label>
              <input type="text" value="" name="inquire_memo" id="inquire_memo" placeholder="ex)국비과정 상담, 한식요리사 상담" required>
              ...
              <ul>
                <li >
                  ...
                  <label for="T09" class="time_on">09 : 00</label>
                </li>
                <li >
                  <input type="radio" name="inquire_time" id="T10" value="10:00">
                  <label for="T10" >10 : 00</label>
                </li>
                <li>
        ...
        <?php }else if($tab == '고객센터') { ?>
          ...
          <article class="notice">
            ...
            <ul>
              <li>
                <p>07.02</p>
                <p><a href="#" title="대학생 여름방학 할인 이벤트">대학생 여름방학 할인 이벤트</a></p>
              </li>
              <li>
                <p>06.02</p>
                <p><a href="#" title="첫 커피 커리어, 바리스타 실무를 위한 특강">첫 커피 커리어, 바리스타 실무를 위한 특강</a></p>
              </li>
              <li>
                <p>05.01</p>
                <p><a href="#" title="5월 가정의 달, 코리아바리스타제과제빵학원의 특별한 혜택">5월 가정의 달, 코리아바리스타제과제빵학원의 특별한 혜택</a></p>
              </li>
              <li>
                <p>04.02</p>
                <p><a href="#" title="4월 한정혜택! 만족 못하셨다면 전액반환 해드립니다">4월 한정혜택! 만족 못하셨다면 전액반환 해드립니다.</a></p>
              </li>
              <li>
                <p>01.12</p>
                <p><a href="#" title="특별한 1+1이벤트 수강료 최대 40%할인">특별한 1+1이벤트 수강료 최대 40%할인</a></p>
              </li>
            </ul>
