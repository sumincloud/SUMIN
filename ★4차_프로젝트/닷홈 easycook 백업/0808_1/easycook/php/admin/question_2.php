        ...
        <div id="container">
          ...
          <nav aria-label="페이지네이션" class="padding50">
            ...
            <?php //페이지네이션이 들어가는 곳
              //이전페이지
              if($page <= 1){ ?> 
                <li class="page-item"><a href="question_3.php?page=1" title="이전페이지로" class="page-link"><i class="fa-solid fa-angle-left"></i></a></li>
                <?php } else{ ?> 
                <li class="page-item"><a href="question_3.php?page=<?php echo ($page-1); ?>" title="이전페이지로" class="page-link "><i class="fa-solid fa-angle-left"></i></a></li>
                <?php };?> 
              <?php //여기서부터 페이지 번호출력하기
                for($print_page=$s_pageNum;$print_page<=$e_pageNum;$print_page++){?>
                <li class="page-item"><a href="question_3.php?page=<?php echo $print_page; ?>" title="선택페이지로" class="page-link">
                  <?php echo $print_page ?>
                </a></li>
              <?php }; ?>  
              <!-- 다음 버튼 나오는 곳 -->
              ...
              <?php }else{ ?>
                <li class="page-item"><a href="question_3.php?page=<?php echo ($page+1); ?>" title="다음페이지로" class="page-link " ><i class="fa-solid fa-angle-right"></i></a></li>
            <?php };   ?>    
          </nav>
        </div>
      </div> 
