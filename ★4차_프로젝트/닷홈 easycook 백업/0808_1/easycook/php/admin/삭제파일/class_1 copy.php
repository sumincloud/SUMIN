...
<main>
  ...
  <!-- 부스러기 -->
    ...
    <article class="class_1">
              ...
              <tr>
                ...
                <td >
                  <a href="student.php?class_no=<?php echo $db['0'];?>" title="">
                    [<?php echo $db['2'];?>][<?php echo  $db['4'];?>]<?php echo  $db['1'];?>
                  </a>
                </td>
                <td class="text-center"><a href="student.php?class_no=<?php echo $db['0'];?>" title="학생페이지로"><?php echo $db['6'];?></a></td>
                <td class="text-center"><a href="student.php?class_no=<?php echo $db['0'];?>" title="학생페이지로"><?php echo $db['3'];?></a></td>
                <td class="text-center"><a href="student.php?class_no=<?php echo $db['0'];?>" title="학생페이지로"><?php echo $db['9'];?></a></td>
                <td class="text-center"><a href="student.php?class_no=<?php echo $db['0'];?>" title="학생페이지로"><?php echo $db['16'];?></a></td>
              </tr>
              <?php     }; ?> 
            </tbody>
            <tfoot>
      ...
      <div class="mt-5 mb-3 row" style="position:relative;">
        <!-- 강의 개설 하기 -->
