...
<head>
  ...
  <title>나의 정보 수정 | 이지쿡</title>
  <?php  include('header.php'); ?>

<main>
  <section class="m-center m-auto mb-5 class_size">
    <!-- 부스러기 -->
    <p class="bread"><a href="index.php">홈</a> &#x003E; 마이페이지 &#x003E; <span style="font-weight:bold">나의 정보 수정</span></p>
    ...
    <script>
      ...
      let txtbox2_2 = txtboxv_2.replace(/(<br>|<br\/>|<br \/>)/g,'\r\n');
      let txtbox2_3 = txtboxv_3.replace(/(<br>|<br\/>|<br \/>)/g,'\r\n');
