...
<head>
  ...
  <section class="m-center m-auto mb-5 class_size">
    <!-- 부스러기 -->
    <p class="bread"><a href="index.php">홈</a> &#x003E; 강의 관리 &#x003E; <span style="font-weight:bold">공지작성</span></p>
    ...
    <form action="notice_input.php" name="답변하기" method="post">
      ...
      <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">강의명</label>
      ...
      <div class="mb-3">
        ...
        <textarea type="text" name="memo" id="memo" class="form-control" cols="50" rows="10"></textarea>
      </div>

      <div class="mt-5" style="position:relative;">
        <a href="class_1.php" title="이전페이지로" class="admin_btn admin_btn_yellow position_l_b">이전페이지</a>
