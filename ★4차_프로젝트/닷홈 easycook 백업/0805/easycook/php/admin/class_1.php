        ...
        <div class="mt-2 mb-2" id="content">
          <div id="container" class="position_relative">
            ...
            <div class="mb-2 admin_search_box">
              ...
              <button class="btn" type="submit" id="button-addon2" style="border: none;"><i class="bi bi-search"></i></button>        
            </div> 
            <script> // 검색어 유효성 검사
              function form_check(){
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="student.php?class_no=<?php echo $db['0'];?>" title="학생페이지로"><?php echo $db['10'];?></a>
                  </td>
                  <!-- 현재강의 이면 녹색으로 하기 -->
                  <?php if($db['17'] == '현재강의'){?>
                    <td class="text-center">
            ...
            <nav aria-label="페이지네이션" class="padding50">
              <ul class="pagination justify-content-center">
                <?php //페이지네이션이 들어가는 곳
                  //이전페이지
                  if($page <= 1){ ?> 
                    <li class="page-item"><a href="class_1.php?page=1" class="page-link" title="이전페이지로"><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php } else{ ?> 
                    <li class="page-item"><a href="class_1.php?page=<?php echo ($page-1); ?>" class="page-link " title="이전페이지로"><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php }; ?> 
                <?php //여기서부터 페이지 번호출력하기
                  ...
                  <?php }else{ ?>
                    <li class="page-item"><a href="class_1.php?page=<?php echo ($page+1); ?>" title="다음페이지로" class="page-link"><i class="fa-solid fa-angle-right"></i></a></li>
                <?php };    ?>
              </ul>
            </nav>   
