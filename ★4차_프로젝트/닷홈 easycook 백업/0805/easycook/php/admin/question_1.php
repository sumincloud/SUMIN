...
<main>
  <section class="m-center m-auto mb-5 class_size">
    ...
    <!-- 제목 -->
    <h2 class="text-center mt-4" style="margin-bottom: 70px;">전체 문의 관리</h2>
    ...
    <article class="class_1" style="position:relative; height: 76vh;">
      <h3>문의 관리</h3>
      <!-- 검색영역 -->
      <form name="검색하기" method="post" action="./question_search.php" onsubmit="return form_check()">
        <!-- 검색버튼 -->
        <div class="mb-2 search_box1">
          ...
          <div id="container">
            ...
            <nav aria-label="페이지네이션" class="padding50">
              ...
              <?php //페이지네이션이 들어가는 곳
                //이전페이지
                if($page <= 1){ ?> 
                  <li class="page-item"><a href="question_1.php?page=1" class="page-link" title="이전페이지로"><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php } 
                  else{ ?> 
                  <li class="page-item"><a href="question_1.php?page=<?php echo ($page-1); ?>" title="이전페이지로" class="page-link "><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php };?> 
                ...
                <?php }else{ ?>
                  <li class="page-item"><a href="question_1.php?page=<?php echo ($page+1); ?>" title="다음페이지로" class="page-link " ><i class="fa-solid fa-angle-right"></i></a></li>
              <?php };    ?>    
              </ul>
            </nav>
