...
<div class="admin_reserve">
  ...
  <div class="mb-3 admin_reserve_con">
    ...
    <?php while ($db = mysqli_fetch_array($result)) { ?>
  ...
  <div class="mb-3 admin_reserve_con">
    ...
    <?php
    // Check if there are results for room 102
      ...
      while ($db2 = mysqli_fetch_array($result2)) { ?>
        <div class="reserve_time">
          ...
          <div class="reserve_p">
            <ul>
            <?php
              $sql4 = "SELECT * FROM room WHERE `start` = '$db[0]' and room_date = '$select_time' AND room = '102'";
              $result4 = mysqli_query($conn, $sql4);
              while($db4 = mysqli_fetch_array($result4)){?>
              <li><?php echo $db4[7]."(".$db4[6].")";?></li>                
            <?php }?>                
            </ul>
          </div>
        </div>
