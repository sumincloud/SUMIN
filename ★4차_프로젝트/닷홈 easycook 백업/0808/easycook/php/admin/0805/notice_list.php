...
<head>
  ...
  <main>
    ...
    ?>
    <!-- 부스러기 -->
    <p class="bread"><a href="index.php">홈</a> &#x003E; 강의 관리 &#x003E; 나의 강의실 &#x003E; <span style="font-weight:bold">공지 관리</span></p>
    ...
    <article id="tab_con">
      <ul>
        ...
        <li><a href="notice_list.php?class_no=<?php echo $class_no;?>" class="act">공지사항</a></li>
      </ul>
    </article>
