...
<head>
  ...
  <main>
    <section class="m-center m-auto mb-5 class_size">
      ...
      ?>
    <!-- 부스러기 -->
    <p class="bread"><a href="index.php">홈</a> &#x003E; 강의 관리 &#x003E; 나의 강의실 &#x003E; <span style="font-weight:bold">공지보기</span></p>

    <!-- 제목 -->
    <h2 class="text-center mt-5 mb-4"> [<?php echo $class['2'];?>][<?php echo  $class['3'];?>][<?php echo $class['4'];?>]<?php echo  $class['1'];?></h2>
    ...
    <article>
      ...
      <div class="mt-5 mb-3" style="position:relative;">
        <!-- 목록으로 -->
        <a href="notice_list.php?class_no=<?php echo $no;?>" title="목록으로" class="admin_btn admin_btn_yellow position_l_b">목록으로</a>
        <!-- 공지 수정/작성 하기 -->
