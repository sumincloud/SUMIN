          ...
          <div id="container">
            ...
            <table class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="EC_notice_view.php?no=<?php echo $db['0'];?>" title="<?php echo $db['1'];?>"><?php echo date("Y.m.d",strtotime($db['3']));?></a></td>
                </tr>
                <?php     }; ?> 
              </tbody>
            </table>
            ...
            <nav aria-label="페이지네이션" class="padding50">
              ...
              <?php //페이지네이션이 들어가는 곳
                //이전페이지
                if($page <= 1){ ?> 
                  <li class="page-item"><a href="EC_notice.php?page=1" title ="이전페이지" class="page-link"><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php } 
                  else{ ?> 
                  <li class="page-item"><a href="EC_notice.php?page=<?php echo ($page-1); ?>" title ="이전페이지" class="page-link "><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php };
                  ?> 
              <?php //여기서부터 페이지 번호출력하기
                ...
                <?php if($page>=$total_page){ ?>
                  <li class="page-item"><a href="EC_notice.php?page=<?php echo $total_page; ?>" title="다음페이지" class="page-link"><i class="fa-solid fa-angle-right"></i></a></li>
                <?php }else{ ?>
                  <li class="page-item"><a href="EC_notice.php?page=<?php echo ($page+1); ?>" title="다음페이지" class="page-link " ><i class="fa-solid fa-angle-right"></i></a></li>
              <?php };     ?>    
              </ul>
            </nav>
