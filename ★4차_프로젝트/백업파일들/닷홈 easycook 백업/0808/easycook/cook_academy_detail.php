  ...
  <main>
    <section class="sub_header">
      ...
      <article class="tab_con cook">
        ...
        <?php include('./php/include/sub_header_detail.php') ?>
      ...
      <article class="t_con cook">
        ...
        <ul>
          <li>
            <a href="./cook_academy_detail.php?class_no=<?= $row['class_no']; ?>" title="상세정보" class="on2 t_mnu">상세정보</a>
          </li>
      ...
      <article id="page">
        <div id="page2">
          <img src="./uploads/class_detail/<?php echo $row["img"] ?>" alt="강의 썸네일 사진" class="img_size">
        </div>
      </article>
