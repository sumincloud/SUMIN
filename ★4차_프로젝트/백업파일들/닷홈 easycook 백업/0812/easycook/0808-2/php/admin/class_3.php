        ...
        <div id="container" class="position_relative">
          ...
          <nav aria-label="페이지네이션" class="padding50">
            ...
            <?php //페이지네이션이 들어가는 곳
              //이전페이지
              if($page <= 1){ ?> 
                <li class="page-item"><a href="class_3.php?page=1" class="page-link" title="이전페이지"><i class="fa-solid fa-angle-left"></i></a></li>
                <?php } 
                else{ ?> 
                <li class="page-item"><a href="class_3.php?page=<?php echo ($page-1); ?>" class="page-link " title="이전페이지"><i class="fa-solid fa-angle-left"></i></a></li>
                <?php };
                ?> 
            <?php //여기서부터 페이지 번호출력하기
              ...
              <?php }else{ ?>
                <li class="page-item"><a href="class_3.php?page=<?php echo ($page+1); ?>" class="page-link" title="다음페이지로"><i class="fa-solid fa-angle-right"></i></a></li>
            <?php };    
            ?>    
          </table>
        </div>
