...
<main>
  ...
  <!-- 부스러기 -->
    ...
    <article class="class_1">
      ...
      <div id="tab_con">
        <ul>
          <li><a href="class_1.php" title="전">전체</a></li>
          ...
          <div class="mt-5" style="position:relative;">
            ...
            <nav aria-label="페이지네이션" class="padding50">
              ...
              <?php //페이지네이션이 들어가는 곳
                //이전페이지
                if($page <= 1){ ?> 
                  <li class="page-item"><a href="class_2.php?page=1" class="page-link"><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php } 
                  else{ ?> 
                  <li class="page-item"><a href="class_2.php?page=<?php echo ($page-1); ?>" class="page-link "><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php };
                  ?> 
              <?php //여기서부터 페이지 번호출력하기
                for($print_page=$s_pageNum;$print_page<=$e_pageNum;$print_page++){?>
                  <li class="page-item"><a href="class_2.php?page=<?php echo $print_page; ?>" class="page-link">
                    <?php echo $print_page ?>
                  </a></li>
                <?php }; ?>  
                ...
                <?php }else{ ?>
                  <li class="page-item"><a href="class_2.php?page=<?php echo ($page+1); ?>" class="page-link " ><i class="fa-solid fa-angle-right"></i></a></li>
              <?php };    ?>   
            </nav>
      </div>
    </article>
