        ...
        <div class="board">
          ...
          <div class="board_con">
            ...
            <div>
              ...
              <?php 
                ...
                $sql3 = "select * from academy_list where teacher_code='$db2[7]' and end_date >= $today limit 4"; 
          ...
          <div class="board_con">
            ...
            <div>
              ...
              <?php 
                $today = (new DateTime())->format('Y-m-d');
                $sql3 = "select * from academy_list where teacher_code='$db2[7]' and start_date< $today limit 4"; 
                $result3 = mysqli_query($conn, $sql3);  
                while($db3=mysqli_fetch_array($result3)){                  
              ?>
                <li>
