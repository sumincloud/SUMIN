            ...
            <tbody>
              ...
              <?php 
                ...
                while($q=mysqli_fetch_row($result)){
                  $query = "select * from academy_list where class_no='$q[1]' and class_status= '현재강의';";
          ...
          <nav aria-label="페이지네이션" class="padding50">
            <ul class="pagination justify-content-center">
              <?php //페이지네이션이 들어가는 곳
                //이전페이지
                if($page <= 1){ ?> 
                  <li class="page-item"><a href="question_3.php?page=1" class="page-link" title="이전페이지로"><i class="fa-solid fa-angle-left"></i></a></li>
                  <?php } 
                  else{ ?> 
